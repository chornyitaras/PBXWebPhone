...
<html>
    ...
    <body>
        ...
        <audio id="voice1" autoplay></audio>
        <p id="state"></p>
        <p id="callState"></p>
        <p id="errState"></p>
        ...
        <script type="text/javascript">
            ...
            var sipserver = 'sip:' + extractDomain(ws_url);

            var username = 'sip:' + phoneLogin + '@' + extractDomain(ws_url);

            var password = <?php echo json_encode($phone_pass) ?>;

            var register = {
                "request": "register",
                "username": username
            };
            var displayname = phoneLogin;

        </script>
        <script type="text/javascript" src="scripts/sipt.js"></script>
